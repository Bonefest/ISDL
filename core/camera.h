...
public:
	...
	//Sleeper - aкамера "доганяет" объект,когда он достигает некой условной границы
...
public:
	...
	void update(double delta);	//Обновляет положение камеры в зависимости от её поведения
